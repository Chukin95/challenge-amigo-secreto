...
Amigo Secreto es una aplicación web divertida e interactiva que te ayuda a organizar y gestionar tu intercambio de regalos de Amigo Secreto. Con una interfaz amigable y encantadoras animaciones, ¡esta aplicación hace que el proceso de asignar regaladores secretos sea muy sencillo!

## ✨ Características

- 👥 Añade participantes con avatares personalizables
- 🎭 Elige el género para cada participante
- 🎲 Asigna Amigos Secretos de forma aleatoria
...
2. Selecciona el género del participante
3. Haz clic en "Añadir" para agregar el participante a la lista
4. Repite los pasos 1-3 para todos los participantes
